...
const PanierSasukeItachi = () => {
  return (
    <>
      <div className="degrade-block">
        <img className="image-overlaypanier" src="/media/figurines/sasuke et itachi.png" alt="Image superposée" />
      </div>
      <div className='containerPanier'>
        ...
        <p className='pricePanier'>95,99 €</p>
        <p className='modèle'>MODÈLE :</p>
        <button className='boitePanier'>Frères Uchiwa avec boîte</button>
        ...
        <p className='descriptionText'>Version super détaillée de la figurine des Frères Uchiwa, deux des personnages <br />
cultes de Naruto.</p>
...
Hauteur: 17 cm</p>
        ...
        <p className='matièreText'>Polyethylene</p>
      </div>
...
export default PanierSasukeItachi;

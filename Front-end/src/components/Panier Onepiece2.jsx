...
const PanierOnepiece2 = () => {
  return (
    <>
      <div className="degrade-block">
        <img className="image-overlaypanier2" src="/media/mangas/manga one piece.png" alt="Image superposée" />
      </div>
      <div className='containerPanier'>
        ...
        <p className='descriptionText'>Version papier du Tome 100 de One Piece, l'univers <br />
...
export default PanierOnepiece2;

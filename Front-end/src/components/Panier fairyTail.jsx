...
const PanierFairyTail = () => {
  return (
    <>
      <div className="degrade-block">
        <img className="image-overlaypanier2" src="/media/mangas/fairy tail.jpg" alt="Image superposée" />
      </div>
      <div className='containerPanier'>
        ...
        <p className='pricePanier'>3,99 €</p>
        <p className='modèle'>MODÈLE :</p>
        <button className='boitePanier'>Fairy Tail avec boîte</button>
        ...
        <p className='descriptionText'>Version papier du Tome 3 de Fairy Tail, l'univers <br />
cultes de Fairy Tail.</p>
...
export default PanierFairyTail;

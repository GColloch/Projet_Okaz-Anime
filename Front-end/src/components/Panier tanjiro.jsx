  ...
  return (
    <>
      <div className="degrade-block">
        <img className="image-overlaypanier" src="/media/figurines/tanjiro.png" alt="Image superposée" />
      </div>
      <div className='containerPanier'>
        ...
        <p className='pricePanier'>83,99 €</p>
        <p className='modèle'>MODÈLE :</p>
        <button className='boitePanier'>Tanjiro avec boîte</button>
        ...
        <p className='descriptionText'>Version super détaillée de la figurine de Tanjiro, un des personnages <br />
cultes de Demon Slayer.</p>
...
Hauteur: 17 cm</p>
  ...
  <p className="textCardPanier">+</p>
  <div className="cardPanier">
    <img src="/media/figurines/trafalgar law.png" alt="Image" />
  </div>
